...
def main():
    ...
    # with open('masters/models/data_splits/data_split.json', 'r') as file:
    #     data = json.load(file)
    ...
    model_names = ['INCEPTIONv3', 'RESNET34']
    model_containers = []
    ...
    for i, model_info in enumerate(model_containers):
        ...
        dataloaders = her2_dataloaders(batch_size, train_cases, val_cases, test_cases, Inception=Inception, InceptionResnet=InceptionResnet)
